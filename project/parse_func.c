...
void ParseRes(char *name, char *node1, char *node2, double value)
{
	...
	printf("   name=%s, node+=%s, node-=%s, R=%e\n", name, node1, node2, value);	//printing values
	nRes++;	//increamenting the count of resistors with every parse
...
void ParseCapIC(char *name, char *node1, char *node2, double value, double init)	//not included in netlist	
{
	printf("[Capacitor parsed ...]\n");
...
void ParseIndIC(char *name, char *node1, char *node2, double value, double init)	//not included in netlist	
{
	printf("[Inductor parsed ...]\n");
